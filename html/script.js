...
$(document).ready(function () {
  $.post("https://notification/Ready", JSON.stringify({}));
});

$(document).on("click", ".Exit-button", function () {
  $("#notification-settings").fadeOut(500);
  $.post("https://notification/Close", JSON.stringify({}));
});

$(document).on("click", ".top-placeholder", function () {
  $.post(
    "https://notification/SelectPosition",
    JSON.stringify({
      position: "top",
    })
  );
...
$(document).on("click", ".Display-Notifications", function () {
  $.post("https://notification/ActiveNotifications");
});

$(document).on("click", ".Hide-Notifications", function () {
  $.post("https://notification/HideNotifications");
});
$(document).on("click", ".Enable-sound", function () {
  $.post("https://notification/EnableSound");
});

$(document).on("click", ".Disable-sound", function () {
  $.post("https://notification/DisableSound");
});
